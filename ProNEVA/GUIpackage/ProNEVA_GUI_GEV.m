function varargout = ProNEVA_GUI_GEV(varargin)
% PRONEVA_GUI_GEV MATLAB code for ProNEVA_GUI_GEV.fig
%      PRONEVA_GUI_GEV, by itself, creates a new PRONEVA_GUI_GEV or raises the existing
%      singleton*.
%
%      H = PRONEVA_GUI_GEV returns the handle to a new PRONEVA_GUI_GEV or the handle to
%      the existing singleton*.
%
%      PRONEVA_GUI_GEV('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PRONEVA_GUI_GEV.M with the given input arguments.
%
%      PRONEVA_GUI_GEV('Property','Value',...) creates a new PRONEVA_GUI_GEV or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ProNEVA_GUI_GEV_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ProNEVA_GUI_GEV_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ProNEVA_GUI_GEV

% Last Modified by GUIDE v2.5 13-May-2018 18:34:35

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ProNEVA_GUI_GEV_OpeningFcn, ...
                   'gui_OutputFcn',  @ProNEVA_GUI_GEV_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ProNEVA_GUI_GEV is made visible.
function ProNEVA_GUI_GEV_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ProNEVA_GUI_GEV (see VARARGIN)

% Choose default command line output for ProNEVA_GUI_GEV
...
% Disable Nonstationary panels in the case of Stat analysis
...
% UIWAIT makes ProNEVA_GUI_GEV wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ProNEVA_GUI_GEV_OutputFcn(hObject, eventdata, handles) 
...
% Load parameters selected in previous set
load('USER_INPUT.mat');

% In the case of stationary model: trend are 'none' by default
if strcmp(RUNspec.DISTR.Model, 'Stat')
...
% Savel Prior info in RUNspec.PRIOR
...
close('ProNEVA_GUI_GEV')                    % Close current GUI
